...
import {
  ...
  QrCode, Edit2, Eye, Download, X, RefreshCw, CreditCard,
} from "lucide-react";
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 gap-3 pt-4">
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
              ...
              <p className="text-xs text-gray-400 mt-1">{summary?.orderCount ?? 0} completed orders</p>
            </div>
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
              <div className="flex items-center gap-2 mb-1">
            ...
            {editingDetails ? (
              <>
                ...
                <div>
                  ...
                  <label className="flex items-center gap-2 cursor-pointer border-2 border-dashed border-gray-200 rounded-xl p-4 hover:border-teal-400 hover:bg-teal-50/30 transition-colors">
