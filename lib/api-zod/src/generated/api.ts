...
export const GetListingsResponseItem = zod.object({
  ...
  fatherPhoto: zod.string().nullish(),
  motherPhoto: zod.string().nullish(),
  maleQuantity: zod.number().optional(),
  femaleQuantity: zod.number().optional(),
  description: zod.string(),
  status: zod.enum(["pending", "approved", "rejected", "sold_out"]),
  petCode: zod.string().nullish(),
  kciCertified: zod.boolean().optional(),
  kciCertificateUrl: zod.string().nullish(),
  address: zod.string(),
  city: zod.string(),
  createdAt: zod.coerce.date(),
});
...
export const CreateListingBody = zod.object({
  ...
  city: zod.string().optional(),
  kciCertified: zod.boolean().optional(),
  kciCertificateUrl: zod.string().optional(),
});
